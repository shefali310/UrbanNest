...
const SearchBar = () => {
  ...
  return (
    <form
      ...
      className="-mt-3 sm:-mt-3 p-3 bg-gray-300 rounded shadow-md grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 items-center gap-4"
    >

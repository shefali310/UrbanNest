...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      console.log("Error creating a hotel:", e);
...
// Edit hotel api with also viewing hotel in detail with id.
...
// After editing hotel, it will save in the database as well as upload images into cloudinary.
